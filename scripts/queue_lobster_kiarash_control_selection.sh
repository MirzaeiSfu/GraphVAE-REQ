...
expected_runs="${3:-2}"
gpu="${4:-0}"
run_root="runs/20260725/lobster_graphvae_mm_fixed_split_controls"
output_dir="runs/20260725/lobster_graphvae_mm_fixed_split_control_validation_selection/$host_label"
session="kiarash_control_select_20260725"
python_bin=""
for candidate in \
